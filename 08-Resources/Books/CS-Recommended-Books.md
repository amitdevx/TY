---
title: "Recommended Books - CS Subjects"
tags:
  - resources
  - books
  - reference
...
| R2 | Operating Systems: Internals and Design Principles | William Stallings | Prentice Hall |
...
| R2 | JavaScript and JQuery | Jon Duckett | Wiley |
| R3 | Eloquent JavaScript (3rd Ed.) | Marijn Haverbeke | No Starch Press |
| R4 | You Don't Know JS: ES6 & Beyond | Kyle Simpson | O'Reilly |
| R5 | CSS: The Definitive Guide | Eric Meyer, Estelle Weyl | O'Reilly |
| R6 | Web Development with Node and Express | Ethan Brown | O'Reilly |
...
| R3 | Theory of Computer Science | K.L.P. Mishra, N. Chandrasekaran | PHI |
...
| R2 | Introduction to Statistical Learning | James, Witten, Hastie |
...
| R2 | Head First Java | Kathy Sierra, Bert Bates |
...
| R2 | Getting Started with Angular | Minko Gechev |
...
| R2 | Node.js in Action | Cantelon, Harter et al. |
| R3 | Learning React | Alex Banks, Eve Porcello |
...
| R2 | Scrum: The Art of Doing Twice the Work in Half the Time | Jeff Sutherland |
| R3 | Succeeding with Agile | Mike Cohn |
