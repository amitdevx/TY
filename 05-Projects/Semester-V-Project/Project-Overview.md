...
```mermaid
gantt
    title Semester V Project Timeline
    dateFormat  YYYY-MM-DD
    section Planning
    Requirement Analysis     :a1, 2026-07-01, 2w
    System Design            :a2, after a1, 2w
    section Development
    Frontend Development     :b1, after a2, 4w
    Backend Development      :b2, after a2, 4w
    Database Setup           :b3, after a2, 1w
    section Testing
    Unit Testing             :c1, after b1, 2w
    Integration Testing      :c2, after c1, 1w
    section Deployment
    Final Deployment         :d1, after c2, 1w
