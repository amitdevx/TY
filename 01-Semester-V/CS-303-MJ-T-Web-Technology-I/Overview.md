---
title: "CS-303-MJ-T Web Technology-I - Overview"
aliases: ["Web Tech I", "CS303", "Web Technology Overview"]
tags:
...
```mermaid
gantt
    title CS-303 Study Timeline
    dateFormat  YYYY-MM-DD
    section Chapter 1
    HTML5 & CSS3        :a1, 2026-06-17, 5d
    section Chapter 2
    ES6+ JavaScript     :a2, after a1, 6d
    section Chapter 3
    Node.js Fundamentals:a3, after a2, 5d
    section Chapter 4
    File Handling       :a4, after a3, 4d
    section Revision
    Full Revision       :a5, after a4, 3d
```
