---
title: "Revision - {{subject}} ({{revision_type}})"
subject: "{{subject}}"
subject_code: "{{subject_code}}"
revision_type: "daily"
# revision_type options: daily | weekly | monthly | pre-exam
date: {{date}}
unit: "{{unit_or_all}}"
revision_round: {{revision_round}}
# revision_round: 1st, 2nd, 3rd review
time_spent: "{{duration}} minutes"
score_before: "{{score_before}}/10"
score_after: "{{score_after}}/10"
semester: "{{semester}}"
tags:
  - revision
  - "{{subject_code}}"
